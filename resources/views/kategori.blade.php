...
<body>
    ...
    <section>
        <div class="container mt-4">
            ...
            <p style="margin-left: 2%; margin-top:-2%; color:rgb(96, 96, 97)">| Semua Kategori</p>
        </div>
        <div class="container-fluid my-4" style="background-color: rgb(190, 215, 235); height: 35vh">
            <div class="container">
                <h1 class="fw-bold text-center " style="color: rgb(15, 73, 128); padding-top:3% ">Pilih Kategori</h1>
                <div class="row text-center mt-5">
                    <div class="col-md-3">
                        <div class="card p-3 border-0 shadow">
                            <a href="/nutrisi"><img src="images/kategori1.webp" style="height: 50%; width:50%; margin-left:10%" alt=""></a>
                            <h5>Nutrisi</h5>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 mt-5">
                        <div class="card p-3 border-0 shadow ">
                            <a href="/mental"><img src="images/kategori5.webp" style="height: 50%; width:50%;" alt=""></a>
                            <h5>Kesehatan Mental</h5>
                        </div>
                    </div>
                    <div class="col-md-3 mt-5">
                        <div class="card p-3 border-0 shadow ">
                            <a href="/gigi"><img src="images/kategori7.webp" style="height: 50%; width:50%;" alt=""></a>
                            <h5>Penyakit Diabetes</h5>
                        </div>
                    </div>
                    <div class="col-md-3 mt-5">
                        <div class="card p-3 border-0 shadow ">
                            <a href="/gigi"><img src="images/kategori8.webp" style="height: 50%; width:50%;" alt=""></a>
                            <h5>Kesehatan Otak dan Saraf</h5>
                        </div>
                    </div>
                    <div class="col-md-3 mt-5">
                        <div class="card p-3 border-0 shadow ">
                            <a href="/gigi"><img src="images/kategori9.webp" style="height: 50%; width:50%;" alt=""></a>
                            <h5>Pola Tidur Sehat</h5>
                        </div>
                    </div>
                    <div class="col-md-3 mt-5">
                        <div class="card p-3 border-0 shadow ">
                            <a href="/gigi"><img src="images/kategori10.png" style="height: 50%; width:50%;" alt=""></a>
                            <h5>Kesehatan</h5>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <footer>
            <div class="container-fluid" style="background-color: #233f64; height: 70vh; margin-top: 40%">
