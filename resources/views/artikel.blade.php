...
<section>
    ...
    <section>
        <div class="container-fluid my-4" style="background-color: rgb(190, 215, 235); height: 15vh">
            <div class="container">
                <h1 class="fw-bold text-center " style="color: rgb(15, 73, 128); padding-top:3% ">Topik Terbaru</h1>
                <div class="container my-5" >
                    <div class="row g-4" style="margin-top: 5%">
                        @foreach ($artikel as  $item)
                        <div class="col-md-3">
                            <img src="{{ asset('storage/gambar/'.$item->gambar)}}" style="border-radius: 15px" class="img-fluid rounded" alt="Gambar Utama">
                            <div class="card-body">
                                <a href="/kebugaran"><span class="badge bg-primary mb-2" style="margin-left: -8px">{{ $item->kategori}}</span></a>
                                ...
                                <a href="/berita2/{{$item->id}}"><h4 style="margin-left: -8px">{{ $item->title}}</h4></a>
                                <p class="text-muted small mb-1" style="margin-left:-8px">{{ $item->tinjauan}} <a href="/berita2/{{$item->id}}"></a></p>
                            </div>
                        </div>
                        @endforeach
                    </div>
    ...
    <section>
        <footer>
            <div class="container-fluid" style="background-color: #233f64; height: 70vh; margin-top: 50%">
