...
<head>
    ...
    <title>Kategori Kebugaran</title>
...
<body>
    ...
    <section>
        ...
        <div class="container-fluid" style="background-color: rgb(247, 236, 191); height: 10vh; margin-top: 2%">
            <div class="container">
                <img src="/images/kategori4.webp" alt="" style="height:13%; width: 13%; margin-left:19%; margin-top: 2%;">
                <h2 class="fw-bold" style="margin-left: 38%;margin-top: -7%">Kebugaran</h2>
                {{-- <hr class="sidebar-divider" style="color: #bec0c2; margin-top: 2px"> --}}
                <h5 class="text-center" style="margin-top: 8%">Asupan nutrisi amat berpengaruh dengan kondisi kesehatan manusia. Cari tahu segala <br> informasi seputar nutrisi, termasuk tips beserta masalah kesehatan terkait melalui artikel- <br>artikel berikut ini.</h5>
    ...
    <section>
        <div class="container">
            <h3 style="margin-top: 5%">Tiga Manfaat Utama Poundfit untuk Kesehatan Tubuh</h3>
            <a href="https://www.youtube.com/watch?v=g7N09yC9wDI"><img src="/images/videokebugaran.PNG" alt=""></a>
        </div>
    </section>
    <section>
        <footer>
