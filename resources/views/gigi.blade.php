...
<body>
    ...
    <section>
        ...
        <div class="container-fluid" style="background-color:rgb(212, 228, 241); height: 15vh; margin-top: 2%">
            <div class="container">
                <img src="images/kategori3.webp" style="height: 15%; width: 15%; margin-left: 9%; margin-top: 2%" alt="">
                <h2 class="fw-bold" style="margin-top: -6%; margin-left: 28%">Kesehatan Gigi dan Mulut</h2><br>
                <hr class="sidebar-divider" style="color: #bec0c2">
                <h5 class="text-center">Tak sedikit orang yang menyepelekan kesehatan gigi dan mulut. Padahal jika gangguan pada <br> gigi dan mulut tak diatasi dengan baik dapat menyebabkan kondisi lain yang serius, Pahami <br> tips menjaga kesehatan gigi dan mulut, serta gangguan yang mungkin terjadi.</h5>
                <hr class="sidebar-divider" style="color: #bec0c2">
                <h3 style="margin-top: 5%">Artikel</h3>
    ...
    <section>
        <div class="container mt-5">
            <h3 style="margin-top: 65%">Langkah Perlindungan dengan Memilih Obat Kumur yang Tepat</h3>
            <a href="https://www.youtube.com/watch?v=xr9R9b4mmEs"><img src="/images/videogigi.PNG" alt=""></a>
        </div>
    </section>
    <section>
