...
<body>
    ...
    <section>
        <div class="container mt-4">
            ...
            <p style="margin-left: 2%; margin-top:-2%; color:rgb(96, 96, 97)">| Nutrisi</p>
        </div>
        <div class="container-fluid" style="background-color: rgb(179, 238, 220); height: 10vh; margin-top: 2%">
            <div class="container">
                <img src="/images/kategori1.webp" alt="" style="height:15%; width: 15%; margin-left:15%; margin-top: 2%;">
                <h2 class="fw-bold" style="margin-left: 38%;margin-top: -7%">Nutrisi</h2>
    ...
    <section>
        <div class="container mt-4">
            <a href="https://www.youtube.com/watch?v=tS8hzh09XOc"><img src="/images/videonutrisi.PNG" alt=""></a>
        </div>
    </section>
    <section>
        <footer>
