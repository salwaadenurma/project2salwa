...
<body>
    ...
    <section>
        <div class="container mt-4">
            ...
            <p style="margin-left: 2%; margin-top:-2%; color:rgb(96, 96, 97)">| Kesehatan kulit</p>
        </div>
        <div class="container-fluid" style="background-color: rgb(197, 221, 243); height: 10vh; margin-top: 2%">
            <div class="container">
                <img src="/images/kategori2.webp" alt="" style="height:16%; width: 16%; margin-left:15%; margin-top: 2%;">
                <h2 class="fw-bold" style="margin-left: 38%;margin-top: -7%">Kesehatan Kulit</h2>
                {{-- <hr class="sidebar-divider" style="color: #bec0c2; margin-top: 2px"> --}}
                <h5 class="text-center" style="margin-top: 8%">Menjaga kulit tetap sehat penting dilakukan. Bila tidak, masalah pada kulit dapat menyerang. Di <br> antaranya adalah jerawat, dermatitis, hingga penyakit kulit infeksi seperti panu dan kutu air. <br> Cari tahu informasi tentang kesehatan kulit, beragam jenis penyakit, beserta penanganannya di <br>sini.</h5>
    ...
    <section>
        <div class="container mt-5">
            <h3>4 Gerakan Senam Wajah untuk Kulit Sehat</h3>
            <a href="https://www.youtube.com/watch?v=HmYcx9TxUwQ"><img src="/images/videosckulit.PNG" alt=""></a>
        </div>
    </section>
    <section>
        <footer>
